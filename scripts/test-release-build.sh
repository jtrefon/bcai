...
./target/release/devnet --help > /dev/null && echo "✅ devnet --help works"
./target/release/jobmanager --help > /dev/null && echo "✅ jobmanager --help works"
./target/release/keygen --help > /dev/null && echo "✅ keygen --help works"
./target/release/dashboard --help > /dev/null && echo "✅ dashboard --help works"
...
cp target/release/devnet test-release-package/
cp target/release/jobmanager test-release-package/
cp target/release/keygen test-release-package/
cp target/release/dashboard test-release-package/
